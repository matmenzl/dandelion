...
if( isset($_POST['wpsc-step']) && $_POST['wpsc-step'] == 4 ){
	...
	if( !empty($diff_array) ){
		$errmsg = __( 'Error: the tar file does not have all the files we requested. Please try again, or contact <a href="https://wpstagecoach.com/support" target="_blank">WP Stagecoach support</a> if it happens again.', 'wpstagecoach' );
