...
function theme_js() {
  ...
  wp_enqueue_script( 'isotope-js', get_template_directory_uri() . '/js/isotope.pkgd.min.js', array('jquery'), '3.0.2', true );
  ...
  wp_enqueue_script( 'jumble_js', get_template_directory_uri() . '/js/jumble.js', array('jquery') );
  ...
  wp_enqueue_script( 'match-height', get_template_directory_uri() . '/js/match-height.js', array('jquery') );
}
