...
class EDD_SL_Plugin_Updater {
	...
	private function api_request( $_action, $_data ) {
		...
		$api_params = array(
			...
			'wpsc-item'		=> $data['item_name'],
			'wpsc-ver'		=> $data['version'],
			'wpsc-user' 	=> $data['username'],
			'wpsc-key' 		=> $data['apikey'],
			'slug' 			=> $this->slug,
			'author'		=> $data['author'],
			'url'           => home_url(),
		);
...
// die;
		...
		if( strpos( $_SERVER['HTTP_HOST'], 'wpstagecoach.com' ) ){
			$api_params['site']	= preg_replace('#https?://#', '', get_option('home') );
		} else {
			$api_params['site']	= preg_replace('#https?://#', '', get_option('home') );
		}
