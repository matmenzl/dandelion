...
if( isset($_POST['wpsc-step']) && $_POST['wpsc-step'] == 7 ){
	...
	if( !isset($_POST['wpsc-cleanup']) ){ // we are on our first run
		...
		if( $result['result'] != 'OK' ){
			...
			echo '<p class="wpstagecoach-textinfo">' . __( 'Here is your new staging site: ', 'wpstagecoach' ) . '<a target="_BLANK" href="http://'.WPSTAGECOACH_STAGE_SITE.'">http://'.WPSTAGECOACH_STAGE_SITE.'</a></p>';
			echo '<p class="wpstagecoach-textinfo">' . __( 'You can log into your new staging site at: ', 'wpstagecoach' ) . '<a target="_BLANK" href="http://' . WPSTAGECOACH_STAGE_SITE . '/wp-admin/">http://' . WPSTAGECOACH_STAGE_SITE . '/wp-admin/</a> ';
